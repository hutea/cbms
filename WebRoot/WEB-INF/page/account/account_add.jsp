...
<script type="text/javascript">
	function checkUsername() {
		...
		$
				.post(
						"${pageContext.request.contextPath}/manage/account/checkUsername.action",
						{
							username : username
						},
						function(data) {
				...
				<div class="contentpanel">
					<div class="panel panel-default">
						...
						<form class="form-horizontal form-bordered" id="inputForm"
							action="<%=basePath%>admin/comeSchool/save" method="POST">
							<div class="panel-body nopadding">
								<div class="form-group">
									<label class="col-sm-4 control-label">用户名</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="username"
											onkeyup="checkUsername()" placeholder="请填写用户名" id="username">
								...
								<!-- <div class="form-group">
							<label class="col-sm-4 control-label">系统默认</label>
							<div class="col-sm-8">
								<input type="checkbox" placeholder="" name="isSystem" checked="checked" value="1"/>
							</div>
						</div> -->
							</div>
							...
							<div class="panel-body nopadding">
								<div class="form-group"
									style="border: 1px solid #d3d3dd;padding: 20px;">
									<div class="col-sm-12">
