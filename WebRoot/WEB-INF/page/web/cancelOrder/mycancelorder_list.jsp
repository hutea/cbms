	...
	<div class="steward1-content">
		...
		<div class="steward1-detail" id="steward1-detail">
			<div id="myOrderContent" class="myOrderContent myOrderDetail" style="border: none; ">
				<ul class="totalTitle">
					<li class="liSelected"><a href="${pageContext.request.contextPath}/user/order/cancellist">所有订单</a></li>
					<li class=""><a href="${pageContext.request.contextPath}/user/order/cancellist?orderType=1">洗车订单</a></li>
					<li class=""><a href="${pageContext.request.contextPath}/user/order/cancellist?orderType=2">保养订单</a></li>
					<li class=""><a href="${pageContext.request.contextPath}/user/order/cancellist?orderType=3">商品订单</a></li>
				</ul>
						...
						<ul class="orderLists">
							<li class="orderTitle">
								<div class="orderTitleLeft">
									...
									<p><a href="${pageContext.request.contextPath}/user/order/cancelorderdetails?orderId=${order.id }">订单编号：${order.id }</a></p>
								</div>
